...
def main():
    ...
    true_dc_ext_23, res_dc_ext_23 = calculate_charge_resolution(path_dc_ext_23)
    true_ac_23, res_ac_23 = calculate_charge_resolution(path_ac_23)
    ...
    output_path = get_plot(f"d191122_dc_tf/plot_charge_resolution/1.pdf")
