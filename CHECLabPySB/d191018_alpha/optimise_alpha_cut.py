...
from CHECLabPySB.d191018_alpha import *
from CHECLabPySB.d191018_alpha.plot_alpha_mc import calculate_rates, li_ma
import numpy as np
...
def main():
    ...
    output = get_plot("d191018_alpha/optimise_alpha_cut/d2019-10-03_simulations_gamma1deg_onoff_nocut.pdf")
    title = "ON/OFF MC (1deg) (No cuts)"
    process(path, output, title, None)
    output = get_plot("d191018_alpha/optimise_alpha_cut/d2019-10-03_simulations_gamma1deg_onoff_softcut.pdf")
    title = "ON/OFF MC (1deg) (Soft cuts)"
    process(path, output, title, CUTS_ONOFF_SOFT)
    output = get_plot("d191018_alpha/optimise_alpha_cut/d2019-10-03_simulations_gamma1deg_onoff_harshcut.pdf")
    title = "ON/OFF MC (1deg) (Harsh cuts)"
    process(path, output, title, CUTS_ONOFF_HARSH)

    path = get_data("d191018_alpha/extract_alpha_mc/d2019-10-03_simulations_gamma1deg_wobble.h5")
    output = get_plot("d191018_alpha/optimise_alpha_cut/d2019-10-03_simulations_gamma1deg_wobble_nocut.pdf")
    title = "Wobble MC (1deg) (No cuts)"
    process(path, output, title, None)
    output = get_plot("d191018_alpha/optimise_alpha_cut/d2019-10-03_simulations_gamma1deg_wobble_cut.pdf")
    title = "Wobble MC (1deg)"
    process(path, output, title, CUTS_WOBBLE)
