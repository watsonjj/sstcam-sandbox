...
class d180907_MC:
    def __init__(self, **kwargs):
        ...
        self.plot_dir = get_plot("sst_rfi/intensity_resolution/illumination_profile/d180907_MC")
        self.angular_response_path = get_data("sst_rfi/intensity_resolution/illumination_profile/transmission_pmma_vs_theta_20150422.dat")
