...
from CHECLabPySB.scripts.cr import *
...
def main():
    ...
    # output_dir = get_plot("cr/charge_resolution/d180514_Lab")
    # path_dict = {
    #     "d180514_Lab_TFPoly": d180514_Lab_TFPoly(),
    #     "d180514_Lab_TFNone": d180514_Lab_TFNone(),
    # }
    # ph = PlotHandler()
    ...
    output_dir = get_plot("cr/charge_resolution/d181010_LabSM_0MHz")
    path_dict = {
        "50mV-GM": d181010_LabSM_0MHz_50mV_TFPoly(),
        "100mV-GM": d181010_LabSM_0MHz_100mV_TFPoly(),
        "200mV-GM": d181010_LabSM_0MHz_200mV_TFPoly(),
    }
    ph = PlotHandler()
    poi = list(path_dict.values())[0].poi
    ph.plot_average_from_dict(path_dict, poi)
